...
# python make_slr_images.py -m ${DATA} --model ${MY_MODEL} --degradation_mode bicubic --sigma_x 0.4
...
python make_downscaled_images.py -m REDS --degradation_mode preset

python downreds.py -m REDS --degradation_mode preset
python downreds.py -m Vid4 --degradation_mode preset
...
python make_downscaled_images.py -m REDS --degradation_mode impulse --sigma_x 0.4 --sigma_y 0.4 --theta 0.0
python make_downscaled_images.py -m Vimeo --degradation_mode impulse --sigma_x 0.4 --sigma_y 0.4 --theta 0.0

python make_downscaled_images.py -m ${DATA} --degradation_mode impulse --sigma_x 0.4 --sigma_y 0.4 --theta 0.0
