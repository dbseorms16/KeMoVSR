...
python test_dynavsr.py -opt options/test/DUF/DUF_R.yml --exp_name duf_test --degradation_type preset

python test_dynavsr.py -opt options/test/EDVR/EDVR_R.yml --exp_name EDVR_R_test --degradation_type preset
